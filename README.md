...
If you want to execute the project you will need [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) and [Docker](https://docs.docker.com/get-docker/). Make sure the three of them are installed in your system. Download the project with `git clone https://github.com/arquisoft/lomap_es5b`. The fastest way to launch everything is with docker:
```bash
...
services:
  restapi:
    image: ghcr.io/arquisoft/lomap_es5b/restapi:latest
    ports:
      - "5000:5000"
  webapp:
    image: ghcr.io/arquisoft/lomap_es5b/webapp:latest
    ports:
      - "3000:3000"
    depends_on: 
      - restapi
...
deploy:
    ...
    - name: Deploy over SSH
      ...
      with:
        ...
        command: |
          wget https://raw.githubusercontent.com/arquisoft/lomap_es5b/master/docker-compose-deploy.yml -O docker-compose.yml
          docker-compose stop
          docker-compose rm -f
          docker-compose pull   
          docker-compose up -d
