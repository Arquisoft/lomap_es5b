...
la url en la que se despliega es: [https://arquisoft.github.io/lomap_es5b/](https://arquisoft.github.io/lomap_es5b/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_es5b/](https://arquisoft.github.io/lomap_es5b/) necesitamos ejecutar `npm run deploy`.
