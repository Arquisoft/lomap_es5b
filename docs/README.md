...
The deployment url is: [https://arquisoft.github.io/lomap_es5b/](https://arquisoft.github.io/lomap_es5b/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/lomap_es5b/](https://arquisoft.github.io/lomap_es5b/) we need to execute `npm run deploy`.
